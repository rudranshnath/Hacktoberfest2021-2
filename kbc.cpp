// THIS Program is created by Rudransh Nath Tripathi.
...
{       clrscr();
	if (x)
		return 0;
	cout<<"\n\n\n\n\n\n\n";
	cout<<"                              Name      : Rudransh Nath Tripathi\n";
	cout<<"                              Class     : XII - A\n";
	cout<<"                          Date Created  : 13/05/2019\n";
	cout<<"                          Date Modified : 18/05/2019\n";
	getch();
	Boundary();
	getch();
	return 0;
...
{       int opt=0;
	...
	{	clrscr();
		...
		cout<<"\t\t#3. Records of Players\n";
		cout<<"\t\t#4. Remove the record of a Player  \n";
		cout<<"\t\t#5. Update the record of a Player \n";
...
{       clrscr();
	int id,flag=0;
	char confirm='n';
	cout<<"Enter id of player whose record to be deleted : ";
	 cin>>id;
	fstream file,temp;
...
{       clrscr();
	int id,opt,flag=0;
	char confirm='n';
	cout<<"Enter id of player whose record to be updated : ";
	 cin>>id;
	fstream file,temp;
	temp.open("temp.dat",ios::out|ios::binary);
	file.open("Player.dat",ios::in|ios::binary);
	...
	{       file.read((char*)&p,sizeof(p));
		...
		{ 	p.putdata();
			flag=1;
			cout<<"Are u sure, u want 2 update? (y/n) \nAnswer :";
			  cin>>confirm;
			if(confirm=='y')
			{	clrscr();
				p.checking();
